...
class ChecklistItemController(private val checklistItemService: ChecklistItemService) : BaseController(ChecklistItem::class.simpleName) {
    ...
    @PostMapping
    fun create(
        @RequestBody createTaskChecklistItemDTO: CreateTaskChecklistItemDTO,
    ): ResponseEntity<ChecklistItemDTO> = try {
        ResponseEntity
            .status(HttpStatus.CREATED)
            .body(checklistItemService.create(createTaskChecklistItemDTO))
    ...
    fun updateById(
        ...
        ResponseEntity
            ...
            .body(checklistItemService.updateById(id, updateTaskChecklistItemDTO))
    } catch (exception: Exception) {
    ...
    fun deleteById(
        ...
        ResponseEntity
            .status(HttpStatus.ACCEPTED)
            .body("${ChecklistItem::class.simpleName} successfully deleted.")
    } catch (exception: Exception) {
